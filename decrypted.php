...
<body>
    <div class="container">
        <h1>Sistem Enkripsi Caesar Cipher - <?php echo $pageTitle; ?></h1>
        ...
        <form action="<?php echo ($action === 'encrypt') ? 'encrypted.php' : 'decrypted.php'; ?>" method="post" class="cipher-form">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            echo '<div class="result-heading">' . ucfirst($action) . ' Result:</div>';
